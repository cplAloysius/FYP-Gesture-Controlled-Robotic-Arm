...
sys.path.append("/opt/ros/melodi/bin/")
sys.path.append("/opt/ros/melodic/lib/python2.7/dist-packages")
sys.path.append("/root/catkin_ws/devel/lib/python2.7/dist-packages")
sys.path.append("/root/dofbot_ws/devel/lib/python2.7/dist-packages")
#ROS
def waitRos():
...
g_color_hsv = None
# 看地图中心初始位置
joints_init_down = [90, 135, 0, 0, 90, 0]
# 向前看
...
def waitSnakeOuthole(color, snake_msg, cur_joint):
    Arm_snake_ctrl.snake_main(color, snake_msg, cur_joint)
...
#             print(pos)
        ...
        #颜色互动玩法
            ...
            if len(snake_msg) == 1 :
                ...
                closeTid = threading.Thread(target = waitSnakeOuthole, args = ("red", snake_msg,cur_joint))
                closeTid.setDaemon(True)
                closeTid.start()
            ...
            if len(snake_msg) == 1 :
                ...
                closeTid = threading.Thread(target = waitSnakeOuthole, args = ("green", snake_msg,cur_joint,))
                closeTid.setDaemon(True)
                closeTid.start()
            ...
            if len(snake_msg) == 1 :
                ...
                closeTid = threading.Thread(target = waitSnakeOuthole, args = ("blue", snake_msg,cur_joint,))
                closeTid.setDaemon(True)
                closeTid.start()
            ...
            if len(snake_msg) == 1 :
                ...
                closeTid = threading.Thread(target = waitSnakeOuthole, args = ("yellow", snake_msg,cur_joint,))
                closeTid.setDaemon(True)
                closeTid.start()
        #颜色抓取
