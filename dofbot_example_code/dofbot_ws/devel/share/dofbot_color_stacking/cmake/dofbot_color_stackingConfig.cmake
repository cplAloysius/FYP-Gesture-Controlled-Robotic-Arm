...
if("TRUE" STREQUAL "TRUE")
  set(dofbot_color_stacking_SOURCE_PREFIX /root/dofbot_ws/src/dofbot_color_stacking)
  set(dofbot_color_stacking_DEVEL_PREFIX /root/dofbot_ws/devel)
  ...
  set(dofbot_color_stacking_INSTALL_PREFIX /root/dofbot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dofbot_color_stacking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/dofbot_ws/src/dofbot_color_stacking/${idir}'.  ${_report}")
    endif()
